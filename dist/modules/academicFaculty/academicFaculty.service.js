...
const createAcademicFacultyIntoDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield academicFaculty_model_1.AcademicFaculty.create(payload);
    return response;
});
const getAllAcademicFacultiesFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield academicFaculty_model_1.AcademicFaculty.find();
    return response;
});
const getAcademicFacultyFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield academicFaculty_model_1.AcademicFaculty.findById(id);
    return response;
});
